...
export function ScreenFlowFrame() {
  ...
  useEffect(() => {
    ...
    if (navBarVariations.length > 0) {
      console.log(
        '[ScreenFlowFrame] Variations:',
        navBarVariations.map((v) => ({
          id: v.id,
          url: v.url,
  ...
  const handleSelectNavVariation = useCallback(
    (variationId: string) => {
  ...
  const handleDeleteNavVariation = useCallback(
    (variationId: string) => {
  ...
  return (
    <div className="w-[990px] max-h-[85vh] overflow-y-auto custom-scrollbar pointer-events-auto bg-[#11121D] border-2 border-[#1F243B] rounded-2xl p-10 pb-60 shadow-2xl text-white">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-300">Define the screens your app needs and their navigation flow</p>
      </div>
      ...
      <div className="mb-6 p-4 bg-[#1A1F32] border border-[#1F243B] rounded-xl">
        <div className="flex items-center justify-between mb-4">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">Does your app require users to sign in?</p>
          </div>
          <button
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-start gap-3 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        {screen.purpose && <p className="text-xs text-slate-500">{screen.purpose}</p>}
                      </div>
                    </div>
                    <div className="flex gap-2">
                      {initialScreen !== screen.id && (
      ...
      <div className="mt-10 p-5 bg-[#1A1F32] border border-[#1F243B] rounded-2xl">
        <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
          <div>
            ...
            <p className="text-xs text-slate-400 mt-1">Configure how users navigate through your app</p>
          </div>
                ...
                {generatedNavBar && (
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-[#11121D] border border-[#2F344B] rounded-lg p-3">
                      ...
                      <div
                        className={`rounded-lg border border-[#2F344B] bg-slate-900 ${getAspectRatioClass(navAspectRatio)} overflow-hidden`}
                      >
                        {generatedNavBar.url ? (
                          <img
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                {/* Edit Instructions */}
                <div>
                  <label className="block text-sm font-medium mb-2 text-slate-300">Edit Instructions</label>
                  <textarea
                    value={editNavPrompt}
                ...
                <div className="text-xs text-slate-400 bg-blue-500/10 border border-blue-500/20 p-3 rounded-lg text-center">
                  Using{' '}
                  <strong className="text-blue-400">{EDIT_MODELS.find((m) => m.value === editNavModel)?.label}</strong>{' '}
                  model with aspect ratio <strong className="text-blue-400">{navAspectRatio}</strong>
                </div>
          ...
          >
            ...
            >
              ...
              <p className="text-slate-300 mb-6">
                Are you sure you want to delete this navigation bar variation? This will permanently remove it from your
                project.
              </p>
      ...
      {screens.length > 0 && screens.length < 3 && (
        <div className="p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-xl">
          <p className="text-sm text-yellow-400">
            Add at least {3 - screens.length} more screen{3 - screens.length !== 1 ? 's' : ''} to continue (minimum 3
            required)
          </p>
        </div>
      )}
        ...
        <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-xl">
          <div className="flex items-center gap-2 text-green-400">
            ...
            <p className="text-sm font-medium">
              You have {screens.length} screen{screens.length !== 1 ? 's' : ''}. You can either add more screens or
