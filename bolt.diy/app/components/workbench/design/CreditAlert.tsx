  ...
  const alertContent = (
    <AnimatePresence>
      <div className="fixed inset-0 z-[999999] flex items-center justify-center p-4 pointer-events-none">
        ...
        >
          <div className="rounded-2xl overflow-hidden shadow-[0_0_50px_rgba(220,38,38,0.3)] border-2 border-red-500/50 bg-[#11121D]">
            {/* Header/Gradient */}
            ...
            <div className="p-6">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-xl font-bold text-white mb-2 flex items-center gap-2">{message}</h3>
                  <p className="text-slate-300 text-sm leading-relaxed mb-6 font-medium">{description}</p>
