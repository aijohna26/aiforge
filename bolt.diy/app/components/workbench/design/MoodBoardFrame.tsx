...
const POPULAR_COLOR_SCHEMES = [
    {
        id: 'modern-dark',
        name: 'Modern Dark',
        colors: ['#6C5CE7', '#A29BFE', '#00D4FF', '#0B0F1C', '#161B2F', '#F8FAFC', '#CBD5F5', '#EF4444', '#22C55E', '#F59E0B'],
        keywords: ['modern', 'professional']
    },
    {
        id: 'ocean-blue',
        name: 'Ocean Blue',
        colors: ['#0EA5E9', '#38BDF8', '#7DD3FC', '#0C4A6E', '#1E40AF', '#F0F9FF', '#BAE6FD', '#DC2626', '#10B981', '#F59E0B'],
        keywords: ['calm', 'trustworthy']
    },
    {
        id: 'sunset-warm',
        name: 'Sunset Warm',
        colors: ['#F97316', '#FB923C', '#FDBA74', '#7C2D12', '#EA580C', '#FFF7ED', '#FED7AA', '#DC2626', '#10B981', '#F59E0B'],
        keywords: ['energetic', 'warm']
    },
    {
        id: 'forest-green',
        name: 'Forest Green',
        colors: ['#10B981', '#34D399', '#6EE7B7', '#064E3B', '#047857', '#ECFDF5', '#A7F3D0', '#EF4444', '#22C55E', '#F59E0B'],
        keywords: ['natural', 'calming']
    },
    {
        id: 'royal-purple',
        name: 'Royal Purple',
        colors: ['#9333EA', '#A855F7', '#C084FC', '#4C1D95', '#7C3AED', '#FAF5FF', '#E9D5FF', '#DC2626', '#10B981', '#F59E0B'],
        keywords: ['luxury', 'creative']
    },
    {
        id: 'minimal-mono',
        name: 'Minimal Mono',
        colors: ['#18181B', '#27272A', '#52525B', '#FAFAFA', '#F4F4F5', '#09090B', '#A1A1AA', '#EF4444', '#22C55E', '#F59E0B'],
...
const TYPOGRAPHY_PRESETS = [
    ...
    { id: 'editorial', headingFont: 'Playfair Display', bodyFont: 'Inter', name: 'Editorial', vibe: 'Premium and readable' },
...
const STYLE_PRESETS = [
    { id: 'modern', name: 'Modern Minimal', description: 'Clean lines, subtle shadows, spacious layouts', keywords: ['minimal', 'clean', 'modern'] },
    { id: 'glassmorphism', name: 'Glassmorphism', description: 'Frosted glass effects, transparency, soft shadows', keywords: ['glass', 'transparent', 'modern'] },
    { id: 'neumorphism', name: 'Neumorphism', description: 'Soft shadows, subtle depth, tactile feel', keywords: ['soft', 'tactile', 'subtle'] },
    { id: 'gradient', name: 'Gradient Pop', description: 'Bold gradients, vibrant colors, eye-catching', keywords: ['vibrant', 'bold', 'colorful'] },
    { id: 'flat', name: 'Flat Design', description: 'No shadows, solid colors, simple shapes', keywords: ['flat', 'simple', 'clean'] },
];
...
export function MoodBoardFrame({ zoom = 1, panX = 0, panY = 0, onImagesChange }: MoodBoardFrameProps) {
    ...
    const [customColors, setCustomColors] = useState<string[]>(['#6C5CE7', '#A29BFE', '#00D4FF', '#0B0F1C', '#161B2F', '#F8FAFC', '#CBD5F5', '#EF4444', '#22C55E', '#F59E0B']);
    ...
    const handleManualEntry = () => {
        const colorScheme = manualTab === 'presets'
            ...
            >
                ...
                <div className="mb-6">
                    ...
                    <p className="text-xs text-gray-500 mt-2">
                        JPG, PNG, GIF, WebP • Max {MAX_IMAGES} images • 10MB each
                    </p>
                            ...
                            <div className="p-6 space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <select
                                            ...
                                            disabled={isGenerating}
                                        >
                                            <option value="gemini" className="bg-[#2a2a2a]">Google</option>
                                            <option value="openai" className="bg-[#2a2a2a]">OpenAI</option>
                                        </select>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <select
                                            ...
                                            disabled={isGenerating}
                                        >
                                            <option value={1} className="bg-[#2a2a2a]">1 image</option>
                                            <option value={2} className="bg-[#2a2a2a]">2 images</option>
                                            <option value={4} className="bg-[#2a2a2a]">4 images</option>
                                            <option value={6} className="bg-[#2a2a2a]">6 images</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div className="bg-blue-500/10 border border-blue-500/20 rounded-lg p-4">
                                    <p className="text-xs text-blue-400">
                                        💡 Tip: Be specific about colors, styles, and mood. The AI will generate {quantity} inspiration {quantity === 1 ? 'image' : 'images'} based on your description.
                                    </p>
                                </div>
                                            ...
                                            {POPULAR_COLOR_SCHEMES.map((scheme) => (
                                                ...
                                                >
                                                    <div className="flex justify-between items-start mb-3">
                                                        <div>
                                                            <p className={`font-semibold ${selectedColorScheme === scheme.id ? 'text-white' : 'text-gray-900'}`}>{scheme.name}</p>
                                                            <p className={`text-xs mt-1 ${selectedColorScheme === scheme.id ? 'text-blue-200' : 'text-gray-600'}`}>{scheme.keywords.join(' • ')}</p>
                                                        </div>
                                                    </div>
                                            ...
                                            >
                                                <div className="flex justify-between items-start">
                                                    <div>
                                                        ...
                                                        <p className="text-xs text-gray-400 mt-1">{preset.headingFont} + {preset.bodyFont}</p>
                                                        <p className="text-xs text-gray-400 mt-1">{preset.vibe}</p>
                                                    </div>
                                                    <div className="text-right">
                                                        <p className="text-base text-white font-semibold" style={{ fontFamily: preset.headingFont }}>Heading</p>
                                                        <p className="text-sm text-gray-300 mt-1" style={{ fontFamily: preset.bodyFont }}>Body text</p>
                                                    </div>
                                                </div>
                                            </button>
                                        ))}
                                            ...
                                            >
                                                ...
                                                <div className="flex flex-wrap gap-1.5 mt-2">
                                                    {preset.keywords.map((keyword) => (
                                                        <span key={keyword} className="px-2 py-0.5 text-[10px] rounded-full bg-[#333] text-gray-300">
                                                            {keyword}
                                                        </span>
                                                    ))}
                                                </div>
