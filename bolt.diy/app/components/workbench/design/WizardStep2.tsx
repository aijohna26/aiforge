                                ...
                                <div className="text-center max-w-md">
                                    ...
                                    <div className="mt-4 p-3 bg-bolt-elements-background-depth-2 rounded-lg text-left space-y-2">
                                        <p className="text-xs text-bolt-elements-textSecondary">
                                            <strong className="text-bolt-elements-textPrimary">📋 Paste:</strong> Copy an image anywhere (right-click on an image → Copy image) then press <kbd className="px-1.5 py-0.5 bg-bolt-elements-background-depth-3 rounded text-[10px] font-mono">Ctrl+V</kbd> or <kbd className="px-1.5 py-0.5 bg-bolt-elements-background-depth-3 rounded text-[10px] font-mono">⌘+V</kbd>
                                        </p>
                                        <p className="text-xs text-bolt-elements-textSecondary">
                                            <strong className="text-bolt-elements-textPrimary">🖱️ Drag:</strong> Drag images from your desktop or browser directly into this area
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="w-80 flex flex-col gap-4 bg-bolt-elements-background-depth-1 rounded-lg p-6 border border-bolt-elements-borderColor overflow-auto">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            onChange={(e) =>
                                updateStep2Data({ typography: e.target.value as any })
                            }
