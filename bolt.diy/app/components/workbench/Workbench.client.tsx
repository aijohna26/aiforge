    ...
    useEffect(() => {
      if (hasPreview) {
        if (expoUrl && !isFullPage) {
          ...
          setSelectedView(isFullPage ? 'code' : 'preview');
        }
      }
    }, [hasPreview, isFullPage, expoUrl]);
    ...
    if (isFullPage) {
      return (
        <div className="relative w-full h-full bg-bolt-elements-background-depth-2 border-l border-bolt-elements-borderColor shadow-sm overflow-hidden flex">
          ...
          <div className="flex-1 flex flex-col min-w-0 border-r border-bolt-elements-borderColor">
              ...
              <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border border-bolt-elements-borderColor shadow-sm rounded-lg overflow-hidden">
                ...
                <div className="relative flex-1 overflow-hidden">
                  ...
                  <View
                    initial={{ x: '100%' }}
                    animate={{
                      x: selectedView === 'preview' ? '0%' : selectedView === 'qr' ? '-100%' : '100%',
                    }}
                  >
                    <Preview setSelectedElement={setSelectedElement} />
                  </View>
