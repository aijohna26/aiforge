...
export function TicketDetailModal({ ticket, onClose }: TicketDetailModalProps) {
  ...
  const typeConfig = {
    epic: {
      ...
      bg: 'bg-orange-500/10 dark:bg-purple-500/10',
    },
              ...
              <div className="flex items-center gap-3">
                <div
                  className={classNames(
                    'flex items-center gap-2 px-3 py-1 rounded-full border border-opacity-20 shadow-sm',
                    type.bg,
                    type.color.replace('text-', 'border-'),
                  )}
                >
                  <div className={classNames(type.icon, type.color, 'text-xs')} />
                  <span
                    className={classNames(type.color, 'capitalize text-[10px] font-black tracking-widest uppercase')}
                  >
                    {ticket.type}
                  </span>
                </div>
          ...
          <div className="grid grid-cols-2 gap-8 sticky top-0 z-20 bg-white/80 dark:bg-[#080808]/80 backdrop-blur-md pb-4 pt-2 -mt-2">
            ...
            <div className="space-y-3">
              ...
              <div className="relative group">
                ...
                <div
                  className={classNames(
                    'absolute right-10 top-1/2 -translate-y-1/2 pointer-events-none drop-shadow-[0_0_8px_rgba(0,0,0,0.1)]',
              ...
              <div className="grid gap-3">
                {ticket.acceptanceCriteria.map((criteria, index) => (
                  ...
                  >
                    ...
                    <p className="text-sm font-bold text-gray-700 dark:text-gray-300 flex-1 leading-snug">{criteria}</p>
                  </div>
                ))}
              </div>
            </div>
