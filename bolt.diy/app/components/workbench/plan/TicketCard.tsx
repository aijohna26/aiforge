    ...
    >
      ...
      <div
        className={classNames(
          ...
          type.bg.replace('bg-', 'bg-').replace('/10', ''),
        )}
      />
      ...
      <div className="flex items-start justify-between mb-4">
        ...
        <div className="flex items-center gap-1.5 translate-x-1">
          ...
          <Tooltip content={priority.label}>
            <div
              className={classNames(
                'flex items-center justify-center w-6 h-6 rounded-lg bg-opacity-10 border border-current border-opacity-10 transition-colors',
                priority.color,
              )}
            >
      ...
      <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-50 dark:border-white/[0.03]">
        <div className="flex items-center gap-2">
          <div
            className={classNames(
              'flex items-center gap-1.5 px-2.5 py-1 rounded-lg border border-opacity-10',
              type.bg,
