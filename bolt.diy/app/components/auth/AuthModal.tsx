        ...
        <div className="p-8 bg-white dark:bg-[#141414] relative z-10 flex flex-col items-center">
          ...
          <div className="relative w-full mb-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-white dark:bg-[#141414] text-gray-500 uppercase tracking-wider">
                or sign in with
              </span>
            </div>
          </div>
          ...
          <div className="mt-8 text-xs text-center text-gray-500 dark:text-gray-400">
            ...
            <a href="#" className="underline hover:text-gray-900 dark:hover:text-gray-200">
              Terms of Service
            </a>{' '}
            and{' '}
            <a href="#" className="underline hover:text-gray-900 dark:hover:text-gray-200">
