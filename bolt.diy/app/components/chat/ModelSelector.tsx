...
export const ModelSelector = ({
  ...
  const filteredModels = useMemo(() => {
    ...
    return baseModels
      ...
      .map((model) => ({
        ...model,
        highlightedLabel: model.label,
        highlightedName: model.name,
      }))
  ...
  return (
    <div className="flex gap-2 flex-col sm:flex-row">
      ...
      <div className="relative flex w-full min-w-[70%]" onKeyDown={handleModelKeyDown} ref={modelDropdownRef}>
        ...
        {isModelDropdownOpen && (
          <div
            className="absolute z-20 w-full mt-1 py-1 rounded-lg border border-bolt-elements-borderColor bg-bolt-elements-background-depth-2 shadow-lg max-w-full"
            role="listbox"
            id="model-listbox"
          >
