...
export default class AnthropicProvider extends BaseProvider {
  ...
  staticModels: ModelInfo[] = [
    // Claude Sonnet 4.5: Default model - balanced performance
    {
  ...
  getModelInstance: (options: {
    ...
    // Map fake future models to real existing models (for backward compatibility)
    if (model === 'claude-sonnet-4-5-20251101') {
