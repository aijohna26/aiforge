...
export async function action({ request, context }: ActionFunctionArgs) {
  ...
  try {
    ...
    // Generate the screen
    const generatedScreen = await agent.generateScreen({ ...branding, userId }, screenRequest);
