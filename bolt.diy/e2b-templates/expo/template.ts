...
const templateDir = path.resolve(__dirname, '../../templates/af-expo-template-v9');
...
export const template = t
    ...
    .setStartCmd("EXPO_NO_TELEMETRY=1 npx expo start --web --port 8082", waitForURL("http://localhost:8082"));
